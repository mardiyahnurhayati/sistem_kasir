        ...
        <div class="panel panel-default">  
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text"  class="form-control" id="platmotor" placeholder="">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text"  class="form-control" id="id_merk" placeholder="">
            </div>
          </div>
          ...
          <div class="form-group row">
           ...
           <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text"  class="form-control" id="tahunterbit" placeholder="">
            </div>
          </div>
